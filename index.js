...
// getShelf
secureApiRouter.get('/shelf/:username', async (req, res) => {
  const userShelfContent = await DB.getShelfContent(req.params.username);
  res.send(userShelfContent);
});

// updateShelf
secureApiRouter.post('/shelf/:username', async (req, res) => {
...
// get shelfStats
secureApiRouter.get('/shelfStats/:username', async (req, res) => {
  const userShelfStats = await DB.getShelfStats(req.params.username);
  res.send(userShelfStats);
});

// update shelfStats
secureApiRouter.post('/shelfStats/:username', async (req, res) => {
  const requestData = req.body;
